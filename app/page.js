  ...
  return (
    <div className="min-h-screen py-8 bg-slate-950">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-center mb-8 text-violet-700">
          Shoe Store
        </h1>
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="bg-gray-800">
            <CardTitle className="text-2xl text-blue-200">
              Create New Order
            </CardTitle>
            <CardDescription className="text-gray-400">
              Select a shoe and fill in the details to create a new order.
            </CardDescription>
          </CardHeader>
          <CardContent className="mt-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="customerName" className="text-lg text-gray-300">
                  Customer Name
                </Label>
                <Input
                  id="customerName"
              ...
              <div className="space-y-2">
                <Label htmlFor="product" className="text-lg text-gray-300">
                  Select Shoe
                </Label>
                <Select
                  onValueChange={handleShoeSelect}
              ...
              <div className="space-y-2">
                <Label htmlFor="quantity" className="text-lg text-gray-300">
                  Quantity
                </Label>
                <Input
                  id="quantity"
              ...
              {selectedShoe && (
                <div className="bg-gray-800 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-blue-300">
                    Rs. {(selectedShoe.price * order.quantity).toFixed(2)}
                  </p>
                </div>
              )}
              <Button
          ...
          <CardFooter className="bg-gray-900">
            <p className="text-sm text-gray-400">
              All fields are required. Make sure to double-check the information
              before submitting.
            </p>
          </CardFooter>
        </Card>
